...
experiment_types = {
    ...
    # 'spiral': 'Generate a spiral that tapers off using 100 drones. The drones should start close together and gradually spread out as they move along the spiral.',
    'dragon': 'Create a dragon shape using 1000 drones. Figure out how to setup the drones such that the overall trajectory is a dragon shape.',
}
