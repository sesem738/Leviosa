...
# experiment_types = { "star": "Generate a star-shaped trajectory using 5 drones. The drones should move in such a way that their "
...
def main():
    ...
    for experiment_type, experiment_prompt in experiment_types.items():
        ...
        experiment_type_dir = os.path.abspath(os.path.join("experiments_gemini_10trials_smooth", timestamped_experiment_type))
